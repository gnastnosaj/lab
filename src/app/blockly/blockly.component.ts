...
export class BlocklyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    (JavaScript as any).text_log = block =>
      `console.log(${(JavaScript as any).valueToCode(block, 'TEXT', (JavaScript as any).ORDER_NONE) || ''})\n`;
    ...
    this.workspace.addChangeListener(() => {
      ...
      pre.innerHTML = (JavaScript as any).workspaceToCode(this.workspace);
  ...
  play() {
    ...
    eval((JavaScript as any).workspaceToCode(this.workspace));
  }
