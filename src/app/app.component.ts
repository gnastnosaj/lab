...
@Component({
  ...
  template: `
    ...
    <ng-container *ngIf="styles['fuchisa']">
      ...
      <a appTheme (click)="fork()" class="github-corner" aria-label="https://github.com/gnastnosaj/lab">
...
export class AppComponent {
  ...
  constructor(public router: Router, private injector: Injector, private http: HttpClient, public rxbus: RxBus) {
    ...
    import(/* webpackChunkName: "cognitive" */ './cognitive/cognitive').then(module => {
      const cognitive = this.injector.get(module.Cognitive);;
  ...
  fork() {
    window.open('https://github.com/gnastnosaj/lab');
  }
}
